...
const Button = (props) => {
    ...
    return (
            <a onClick={click} className={classes.mainButton}>
                <svg width="315" height="60" viewBox="0 0 302 62" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <defs>


                        <linearGradient id="gradient" x1="0%" y1="0%" x2="0%" y2="100%">
                            <stop offset="0%"   stop-color="rgba(2,0,36,.8) "/>
                            <stop offset="68%"  stop-color="rgba(169,132,210,0.2435749299719888)"/>
                            <stop offset="100%" stop-color="rgba(2,0,36,.8)"/>
                        </linearGradient>
                    </defs>
